% regolith-mate-polkit(SECTION) | User Commands
%
% "December 16 2022"
...
regolith-mate-polkit - program to do something

# SYNOPSIS

**regolith-mate-polkit** **-e** _this_ [**\-\-example=that**] [{**-e** | **\-\-example**} _this_]
                 [{**-e** | **\-\-example**} {_this_ | _that_}]

**regolith-mate-polkit** [{**-h** | *\-\-help**} | {**-v** | **\-\-version**}]

# DESCRIPTION

This manual page documents briefly the **regolith-mate-polkit** and **bar** commands.

This manual page was written for the Debian distribution because the
original program does not have a manual page. Instead, it has documentation
in the GNU info(1) format; see below.

**regolith-mate-polkit** is a program that...
...
:   The system-wide configuration file to control the behaviour of
    regolith-mate-polkit. See **foo.conf**(5) for further details.
...
**regolith-mate-polkit** provides some return codes, that can be used in scripts:
...
soumyarp <soumyaranjan1812@gmail.com>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright © 2007 soumyarp
